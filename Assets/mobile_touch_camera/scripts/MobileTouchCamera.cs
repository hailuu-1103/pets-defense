...
namespace BitBenderGames
{
    ...
    public class MobileTouchCamera : MonoBehaviourWrapped
    {
        ...
        [SerializeField] [Tooltip("When using a perspective camera, the zoom can either be performed by changing the field of view, or by moving the camera closer to the scene.")]
...
#pragma warning restore 649
        ...
        [Header("Keyboard & Mouse Input")] [Tooltip("Here you can define all platforms that should support keyboard and mouse input for controlling the camera.")] [SerializeField]
        private List<RuntimePlatform> keyboardAndMousePlatforms = new List<RuntimePlatform>()
        {
            RuntimePlatform.WindowsEditor, RuntimePlatform.WindowsPlayer, RuntimePlatform.OSXEditor, RuntimePlatform.OSXPlayer, RuntimePlatform.LinuxEditor, RuntimePlatform.LinuxPlayer,
        ...
        [SerializeField] [Tooltip("When close to the border the camera will spring back if the margin is bigger than 0. This variable defines the speed of the spring back.")]
        private float dragBackSpringFactor = 10;

        [SerializeField] [Tooltip("When swiping over the screen the camera will keep scrolling a while before coming to a halt. This variable limits the maximum velocity of the auto scroll.")]
        ...
        [SerializeField] [Tooltip("A gesture may be interpreted as intended rotation in case the relative rotation angle between 2 frames becomes bigger than this value.")]
        ...
        [SerializeField] [Tooltip("After this amount of finger-movement (relative to screen size), the pinch mode is decided. E.g. whether tilt mode or regular mode is used.")]
        ...
        public Vector2 CameraScrollVelocity { get { return cameraScrollVelocity; } set { cameraScrollVelocity = value; } }
        ...
        public void OnDragSceneObject() { isDraggingSceneObject = true; }
        ...
        /// </summary>
        private void SetTargetPosition(Vector3 newPositionClamped) { targetPositionClamped = newPositionClamped; }
        ...
        private Vector2 GetVector2Min(Vector2 v0, Vector2 v1, Vector2 v2, Vector2 v3) { return new Vector2(Mathf.Min(v0.x, v1.x, v2.x, v3.x), Mathf.Min(v0.y, v1.y, v2.y, v3.y)); }

        private Vector2 GetVector2Max(Vector2 v0, Vector2 v1, Vector2 v2, Vector2 v3) { return new Vector2(Mathf.Max(v0.x, v1.x, v2.x, v3.x), Mathf.Max(v0.y, v1.y, v2.y, v3.y)); }
        ...
        private void InputControllerOnFingerDown(Vector3 pos) { cameraScrollVelocity = Vector3.zero; }

        private void InputControllerOnFingerUp() { isDraggingSceneObject = false; }
